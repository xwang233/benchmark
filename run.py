...
def run_one_step(func, nwarmup=WARMUP_ROUNDS, model_flops=None, num_iter=10, export_all_records=False):
...
if __name__ == "__main__":
    ...
    if args.profile:
        ...
        run_one_step(test, model_flops=model_flops, export_all_records=args.export_all_records)
